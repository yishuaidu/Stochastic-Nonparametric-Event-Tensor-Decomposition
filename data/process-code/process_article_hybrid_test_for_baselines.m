...
n_test = 5;
train = load('../article-train-hybrid-1-300.mat');
nvec = max(train.data.ind);
% 改成原来的10000个testing 换个名字然后带入911more
%test_data = '../article-test-hybrid-1-300-all-remaining.mat';
test_data = '../article-test-hybrid-1-300.mat';
load(test_data);
%改名字记得
res_file = '../article-test-hybrid-baselines-10K.mat';
%res_file = '../article-test-hybrid-baselines.mat';
