...
%core input files
train_file = '../data/911-train-hybrid-1-300.mat';
test_file = '../data/911-test-hybrid-1-300.mat';
R = 1;
time_steps = 5;%10, 20, 30
model_file = strcat('./cp-markov-pp-911-R-', num2str(R), '-TimeStep-', num2str(time_steps), '-models.mat');
res_file =   strcat('./cp-markov-pp-911-R-', num2str(R), '-TimeStep-', num2str(time_steps), '-all.mat');
decay = 0.99; %article
nepoch = 100;
